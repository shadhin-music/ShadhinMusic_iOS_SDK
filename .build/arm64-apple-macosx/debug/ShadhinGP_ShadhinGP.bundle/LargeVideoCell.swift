//
//  LargeVideoCell.swift
//  Shadhin
//
//  Created by Gakk Media Ltd on 10/15/19.
//  Copyright © 2019 Gakk Media Ltd. All rights reserved.
//

import UIKit

class LargeVideoCell: UICollectionViewCell {
    ...
    override func awakeFromNib() {
        ...
        musicVideoArtistLbl.translatesAutoresizingMaskIntoConstraints = false
        musicVideoArtistLbl.leftAnchor.constraint(equalTo: leftAnchor, constant: 10).isActive = true
        musicVideoTitleLbl.translatesAutoresizingMaskIntoConstraints = false
        musicVideoTitleLbl.leftAnchor.constraint(equalTo: leftAnchor, constant: 10).isActive = true
    }
    ...
    func configureCell(model: CommonContentProtocol) {
        ...
        musicVideoImgView.kf.setImage(with: URL(string: imgUrl.safeUrl()),placeholder: UIImage(named: "default_video",in: Bundle.ShadhinMusicSdk,compatibleWith: nil)) { result in
