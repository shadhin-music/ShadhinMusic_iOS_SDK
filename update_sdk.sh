...
echo -e "${YELLOW}🔄 Step 1: Syncing latest files from GitLab project...${NC}"
...
echo -e "${YELLOW}🏷️  Step 3: Tagging version $VERSION...${NC}"
git tag $VERSION
...
echo -e "🔗 ${YELLOW}https://github.com/shadhin-music/ShadhinMusic_iOS_SDK${NC}"#!/bin/bash
