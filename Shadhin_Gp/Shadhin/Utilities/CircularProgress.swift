...
class CircularProgress: UIView {
    ...
    @IBInspectable  var titleLabel = UILabel(frame: .zero)
    ...
    /// Stroke background color
    @IBInspectable  var backgroundShapeColor: UIColor = UIColor(white: 0.9, alpha: 0.5) {
        didSet {
            updateShapes()
        }
    }
    ...
    @IBInspectable  var progressShapeColor: UIColor   = UIColor.tintColor {
        didSet {
            updateShapes()
        }
    }
    ...
    /// Space value
    @IBInspectable  var spaceDegree: CGFloat = 0.0 {
        didSet {
            //            if spaceDegree < 45.0{
            //                spaceDegree = 45.0
            //            }
    ...
    @IBInspectable  var percentLabelFormat: String = "%.f%%" {
        didSet {
            percentLabel.text = String(format: percentLabelFormat, progress * 100)
        }
    }
    
    @IBInspectable  var percentColor: UIColor = UIColor(white: 0.9, alpha: 0.5) {
        didSet {
    ...
    @IBInspectable  var titleColor: UIColor = UIColor(white: 0.9, alpha: 0.5) {
        didSet {
    ...
    /// Duration for a complete animation from 0.0 to 1.0.
     var completeDuration: Double = 2.0
