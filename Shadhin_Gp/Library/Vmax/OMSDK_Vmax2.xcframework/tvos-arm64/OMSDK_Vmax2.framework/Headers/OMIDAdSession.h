 ...
 */
@interface OMIDVmax2AdSession : NSObject

/**
 *  The AdSession configuration is used for check owners.
 */
@property(nonatomic, readonly) OMIDVmax2AdSessionConfiguration *configuration;
/**
 ...
 */
- (nullable instancetype)initWithConfiguration:(OMIDVmax2AdSessionConfiguration *)configuration
                              adSessionContext:(OMIDVmax2AdSessionContext *)context
