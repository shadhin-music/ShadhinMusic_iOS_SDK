 ...
 */
@interface OMIDVmax2AdSessionContext : NSObject
 ...
 * @see OMIDSDK
 */
- (nullable instancetype)initWithPartner:(OMIDVmax2Partner *)partner
...
- (nullable instancetype)initWithPartner:(OMIDVmax2Partner *)partner
                               ...
                               resources:(NSArray<OMIDVmax2VerificationScriptResource *> *)resources
                              contentUrl:(nullable NSString *)contentUrl
               customReferenceIdentifier:(nullable NSString *)customReferenceIdentifier
                                   error:(NSError *_Nullable *_Nullable)error;
