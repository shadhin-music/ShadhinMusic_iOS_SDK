 ...
 */
@interface OMIDVmax2AdEvents : NSObject
 ...
 */
- (nullable instancetype)initWithAdSession:(nonnull OMIDVmax2AdSession *)session error:(NSError * _Nullable * _Nullable)error;
 ...
 */
- (BOOL)loadedWithVastProperties:(OMIDVmax2VASTProperties *_Nonnull)vastProperties
