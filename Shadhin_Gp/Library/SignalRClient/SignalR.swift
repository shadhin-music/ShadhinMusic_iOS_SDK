...
class SignalR {
    ...
    private func connect(){
        ...
        let serverUrl = "\(APIServiceCore.BASE_URL_LIVE)/banglalinkPodcastOnline?contentType=\(SignalR.podcastCode.uppercased())"
        ...
        self.chatHubConnection!.on(method: "banglalinkOnlineUser") { response in
