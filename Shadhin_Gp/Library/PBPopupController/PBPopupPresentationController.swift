...
internal class PBPopupPresentationController: UIPresentationController
{
    ...
    override func presentationTransitionWillBegin()
    {
        ...
        if let stackViewForPresentation = self.stackViewForPresentation {
            self.popupContentView.contentView.addSubview(stackViewForPresentation)
        ...
        coordinator.animate {context in
            ...
            self.popupContentView.popupStackView?.isHidden = false
            self.popupContentView.popupStackModule?.isHidden = false
        }
    }
...
extension PBPopupPresentationController
{
    ...
    private func setupPopupBarForPresentation() -> UIView?
    {
        ...
        if !self.isCompactOrPhoneInLandscape() && self.popupContentView.popupStackView != nil {
    ...
    private func setupStackViewForPresentation() -> PBPopupBarTitlesView?
    {
        ...
        if self.presentingVC.popupBar.popupBarStyle == .prominent, let stackView = self.popupContentView.popupStackView, let shadowStackView = self.presentingVC.popupBar.shadowStackView  {
    ...
    private func configureStackViewInStartPosition()
    {
        ...
        guard let stackView = self.popupContentView.popupStackView else { return }
        ...
        if let stackModule = self.popupContentView.popupStackModule{
